export declare const TYPEID_NotImplementedType = 0;
export declare const TYPEID_NoneType           = 1;
export declare const TYPEID_int                = 2;
export declare const TYPEID_jsint              = 3;
