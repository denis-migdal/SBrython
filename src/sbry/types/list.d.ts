...
export declare const TYPEID_None              : BRAND<2  , "TYPE_ID">;
export declare const TYPEID_NotImplementedType: BRAND<3  , "TYPE_ID">;
export declare const TYPEID_NotImplemented    : BRAND<4  , "TYPE_ID">;
export declare const TYPEID_type              : BRAND<5  , "TYPE_ID">;
export declare const TYPEID_type_int_         : BRAND<6  , "TYPE_ID">;
export declare const TYPEID_int               : BRAND<7  , "TYPE_ID">;
export declare const TYPEID_type_jsint_       : BRAND<8  , "TYPE_ID">;
export declare const TYPEID_jsint             : BRAND<9  , "TYPE_ID">;
export declare const TYPEID_type_float_       : BRAND<10 , "TYPE_ID">;
