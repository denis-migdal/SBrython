...
# long integers
import math
assert 10 ** 50 / math.pi == 3.183098861837907e+49 # {"COMPAT": "PERF"}
assert 10 ** 50 // math.pi == 3.183098861837907e+49 # {"COMPAT": "PERF"}
assert 10 ** 50 / 2 == 5e+49 # {"COMPAT": "PERF"}
assert 10 ** 50 // 2 == 50000000000000000000000000000000000000000000000000 # {"COMPAT": "PERF"}
...
# issue 1338
assert -100000000000000 % 14000000000000000 == 13900000000000000 # {"COMPAT": "PERF"}
...
s = 0x2000000000003f
assert 0x2000000000003f == 9007199254741055   # {"COMPAT": "PERF"}
assert +0x2000000000003f == 9007199254741055  # {"COMPAT": "PERF"}
assert -0x2000000000003f == -9007199254741055 # {"COMPAT": "PERF"}
assert ~0x2000000000003f == -9007199254741056 # {"COMPAT": "PERF"}
...
# issue 1578
assert str(1e-6) == "1e-06"             # {"COMPAT": "PERF"}
assert str(1e-7) == "1e-07"             # {"COMPAT": "PERF"}
assert str(1e-8) == "1e-08"             # {"COMPAT": "PERF"}
assert str(1e-12) == "1e-12"            # {"COMPAT": "PERF"}
assert str(1.2e-123) == "1.2e-123"      # {"COMPAT": "PERF"}
assert str(1e6) == "1000000.0"          # {"COMPAT": "PERF"}
assert str(1e7) == "10000000.0"         # {"COMPAT": "PERF"}
assert str(1e8) == "100000000.0"        # {"COMPAT": "PERF"}
assert str(1e12) == "1000000000000.0"   # {"COMPAT": "PERF"}
assert str(1.2e123) == "1.2e+123"       # {"COMPAT": "PERF"}
...
x = 65152
x <<= 112
assert x == 338288524927261089654018896841347694592 # {"COMPAT": "PERF"}
...
gAnswer = (ltnzi64 - nzi64) % (2 ** 64)       # {"COMPAT": "PERF"}
assert gAnswer == 0xAAF3C2EF5D598ACC, gAnswer # {"COMPAT": "PERF"}
