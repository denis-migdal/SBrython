...
# long integers
import math
assert 10 ** 50 / math.pi == 3.183098861837907e+49 # {"COMPAT_LEVEL": "Mix"}
assert 10 ** 50 // math.pi == 3.183098861837907e+49 # {"COMPAT_LEVEL": "Mix"}
assert 10 ** 50 / 2 == 5e+49 # {"COMPAT_LEVEL": "Mix"}
assert 10 ** 50 // 2 == 50000000000000000000000000000000000000000000000000 # {"COMPAT_LEVEL": "Mix"}
...
# issue 1338
assert -100000000000000 % 14000000000000000 == 13900000000000000 # {"COMPAT_LEVEL": "Mix"}
...
# issue 1578
assert str(1e-6) == "1e-06"             # {"COMPAT_LEVEL": "Mix"}
assert str(1e-7) == "1e-07"             # {"COMPAT_LEVEL": "Mix"}
assert str(1e-8) == "1e-08"             # {"COMPAT_LEVEL": "Mix"}
assert str(1e-12) == "1e-12"            # {"COMPAT_LEVEL": "Mix"}
assert str(1.2e-123) == "1.2e-123"      # {"COMPAT_LEVEL": "Mix"}
assert str(1e6) == "1000000.0"          # {"COMPAT_LEVEL": "Mix"}
assert str(1e7) == "10000000.0"         # {"COMPAT_LEVEL": "Mix"}
assert str(1e8) == "100000000.0"        # {"COMPAT_LEVEL": "Mix"}
assert str(1e12) == "1000000000000.0"   # {"COMPAT_LEVEL": "Mix"}
assert str(1.2e123) == "1.2e+123"       # {"COMPAT_LEVEL": "Mix"}
...
# issue 1840
assert 0 // 10 ** 100 == 0 # {"COMPAT_LEVEL": "Mix"}
...
gAnswer = (ltnzi64 - nzi64) % (2 ** 64)       # {"COMPAT_LEVEL": "Mix"}
assert gAnswer == 0xAAF3C2EF5D598ACC, gAnswer # {"COMPAT_LEVEL": "Mix"}
